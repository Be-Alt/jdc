...
async function assertEnrollmentOwner(sql, ownerId, enrollmentId) {
...
async function resolveTeacherId(sql, ownerId, enrollmentId, teacherId) {
...
async function listStudentData(sql, ownerId, enrollmentId) {
